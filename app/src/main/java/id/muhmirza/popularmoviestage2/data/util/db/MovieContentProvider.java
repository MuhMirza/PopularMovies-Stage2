package id.muhmirza.popularmoviestage2.data.util.db;
...
import static id.muhmirza.popularmoviestage2.data.util.db.MovieContract.MovieEntry.TABLE_NAME;


/**
 * Created by alodokter-it on 29/07/17 -- MovieContentProvider.
 */
