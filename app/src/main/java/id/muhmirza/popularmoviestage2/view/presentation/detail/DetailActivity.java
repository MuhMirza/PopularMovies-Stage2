package id.muhmirza.popularmoviestage2.view.presentation.detail;
...
import id.muhmirza.popularmoviestage2.data.event.MovieReviewErrorEvent;
import id.muhmirza.popularmoviestage2.data.event.MovieReviewEvent;
import id.muhmirza.popularmoviestage2.data.event.MovieTrailerErrorEvent;
import id.muhmirza.popularmoviestage2.data.event.MovieTrailerEvent;
import id.muhmirza.popularmoviestage2.data.model.Movie;
import id.muhmirza.popularmoviestage2.data.model.Review;
import id.muhmirza.popularmoviestage2.data.model.Video;
...
import id.muhmirza.popularmoviestage2.view.presentation.adapter.ReviewsAdapter;
import id.muhmirza.popularmoviestage2.view.presentation.adapter.TrailersAdapter;
